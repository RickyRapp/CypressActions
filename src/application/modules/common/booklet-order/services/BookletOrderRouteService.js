...
class BookletOrderRouteService extends BaseRouteService {
    ...
    find(filter) {
        return super.find(this.base + '/{?donorId,search,trackingNumber,dateCreatedFrom,dateCreatedTo,confirmationNumber,deliveryMethodTypeIds,bookletCodes,bookletOrderStatusIds,name,orderFolder,taxId,isCustom,page,rpp,sort,embed,fields}', filter);
    }
