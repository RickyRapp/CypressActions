...
function ContributionMainListTemplate({ contributionMainListViewStore }) {
    const {
        queryUtility,
        loaderStore,
        tableStore,
...
export default defaultTemplate(ContributionMainListTemplate);
