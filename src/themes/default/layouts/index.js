...
export {
  default as PageNavigationTemplate
} from './page/PageNavigationTemplate';
export {
  default as PageContentHeaderTemplate
} from './page/PageContentHeaderTemplate';
export {
  default as PageContentFooterTemplate
} from './page/PageContentFooterTemplate';
export {
  default as PageContentSidebarTemplate
} from './page/PageContentSidebarTemplate';
...
export {
  default as LanguageEditLayoutTemplate
} from './LanguageEditLayoutTemplate';
export {
  default as ListSelectLayoutTemplate
} from './ListSelectLayoutTemplate';
