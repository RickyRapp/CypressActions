...
class SessionRouteService extends BaseRouteService {
    ...
    find(filter) {
        return super.find(this.base + '/{?search,confirmationNumber,donationStatusIds,paymentTypeIds,paymentNumber,bookletCertificateCode,dateCreatedFrom,dateCreatedTo,name,charityId,page,rpp,sort,embed,fields}', filter);
    }
