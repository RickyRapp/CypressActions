			...
			<Content loading={contentLoading}>
					...
					<div className="row u-mar--bottom--lrg">
						...
						<div className="col col-sml-12 col-xxlrg-4">
							<div className="card--sml card--secondary type--center">
								<h2 className="type--xlrg type--wgt--medium type--color--note">
									{' '}
									<span className="type--med type--color--text">Balance:</span>{' '}
									{donor && (
										<FormatterResolver
									...
									<React.Fragment>
										{denominationTypes.map((dt, index) => {
											const order = orderContents.some(s => s.bookletTypeId === bt.id && s.denominationTypeId === dt.id)
												? orderContents.find(s => s.bookletTypeId === bt.id && s.denominationTypeId === dt.id)
												: null;
											...
											return (
												<React.Fragment key={dt.id}>
													<div
														className="col col-sml-12 col-xxlrg-5 card--med u-align--self--end"
													...
													{index % 2 === 0 && <div className="col-xxlrg-1"></div>}
												</React.Fragment>
											);
										})}
									</React.Fragment>
					...
					<div className="card--sml">
						<div className="row u-display--flex u-display--flex--align--end">
							...
							<div className="col col-sml-12 col-xlrg-4">
								<div className="type--med type--wgt--medium u-push--from--lrg">
									Total:
						...
						{deliveryMethodTypes.map(c => {
							return (
								<div key={c.id} className="col col-sml-12 col-med-12 col-lrg-3 u-mar--bottom--sml">
									<BasicRadio label={c.name} value={c.id} field={form.$('deliveryMethodTypeId')} />
								</div>
							);
						})}
					</div>
				...
				<div className="card--primary card--med u-mar--bottom--med">
					...
					<div className="row u-mar--top--sml u-mar--bottom--sml">
						...
						<div className="col col-sml-12 col-med-6 col-xxlrg-4">
							<BaasicButton
								className="btn btn--100 btn--primary"
								label={
									form.$('addressLine1').disabled
