...
class ContributionRouteService extends BaseRouteService {
    ...
    find(filter) {
        return super.find(this.base + '/{?donorAccountId,paymentTypeIds,confirmationNumber,contributionStatusIds,amountRangeMin,amountRangeMax,accountTypeId,dateCreatedFrom,dateCreatedTo,search,nameOnCheck,contributionId,page,rpp,sort,embed,fields}', filter);
    }
