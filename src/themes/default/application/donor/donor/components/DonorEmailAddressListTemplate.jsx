...
import { BaasicButton, BaasicModal, SimpleBaasicTable, EmptyState, ListContent } from 'core/components';
...
const DonorEmailAddressListTableTemplate = function({ donorEmailAddressViewStore, t }) {
	const { tableStore, routes, emailAddressModal, openEmailAddressModal } = donorEmailAddressViewStore;
...
function renderEmpty(routes) {
	return (
		<EmptyState
			image={EmptyIcon}
			title="EMAIL_ADDRESS.LIST.EMPTY_STATE.TITLE"
			actionLabel="EMAIL_ADDRESS.LIST.EMPTY_STATE.ACTION"
