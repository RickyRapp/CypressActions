...
import { BaasicTableRow, BaasicPager, BaasicPageSizeSelect } from 'core/components';
...
function BaasicTableTemplate({ tableStore, actionsComponent, ...otherProps }) {
    const { data, config: { columns, actions }, queryUtility } = tableStore;
    ...
    return (
        <div className="row">
                        ...
                        <tr>
                            {
                                columns.map(column => {
                                    ...
                                    return (
                                        <th {...headerProps} key={column.key} className="table__head--data">
            ...
            <BaasicPageSizeSelect queryUtility={queryUtility} options={pageSizeOptions} placeholder='Select page size' />
        </div>
    )
}
