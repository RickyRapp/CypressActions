...
function DisplayError({ errorStore }) {
    ...
    const backLink = <button className='btn btn--med btn--tertiary display--ib'
                             onClick={() => rootStore.routerStore.goTo('master.app.main.dashboard')}>GO TO DASHBOARD</button>;
    return (
        <React.Fragment>
            <div className='layout--error'>
                <div className='card card--xlrg card--primary type--center w--1024--max align--h--center'>
                    <svg width='200px' viewBox='0 0 48 32'>
                        <path fill='#ff4040' d='M29.9,19.5C29.7,19.8,29.4,20,29,20c-0.2,0-0.4,0-0.5-0.1c-2.8-1.7-6.2-1.7-9,0c-0.4,0.3-1.1,0.2-1.4-0.2s-0.2-1.1,0.2-1.4
