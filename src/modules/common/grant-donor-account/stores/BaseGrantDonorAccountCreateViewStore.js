...
class BaseGrantDonorAccountCreateViewStore extends BaseEditViewStore {
    ...
    @action.bound async onChangeAmount() {
        if (this.form.$('amount').value && this.form.$('amount').isValid) {
            ...
            if (this.form.$('amount').value < this.applicationDefaultSetting.grantMinimumRegularAmount) {
                //combined
                this.form.$('grant.grantAcknowledgmentTypeId').set('value', this.applicationDefaultSetting.grantAcknowledgmentTypeId);
                this.form.$('grant.grantPurposeTypeId').set('value', this.applicationDefaultSetting.grantPurposeTypeId);
                this.form.$('grant.grantAcknowledgmentTypeId').set('disabled', true);
                this.form.$('grant.grantAcknowledgmentTypeId').resetValidation();
                this.form.$('grant.grantPurposeTypeId').set('disabled', true);
                this.form.$('grant.grantPurposeTypeId').resetValidation();
            }
            else { //regular
                this.form.$('grant.grantAcknowledgmentTypeId').set('disabled', false);
                this.form.$('grant.grantAcknowledgmentTypeId').resetValidation();
                this.form.$('grant.grantPurposeTypeId').set('disabled', false);
                this.form.$('grant.grantPurposeTypeId').resetValidation();
            }
        }
        else {
...
export default BaseGrantDonorAccountCreateViewStore;