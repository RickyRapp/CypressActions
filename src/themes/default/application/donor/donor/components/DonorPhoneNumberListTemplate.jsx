...
import { BaasicButton, BaasicModal, EmptyState, ListContent, SimpleBaasicTable } from 'core/components';
...
const DonorPhoneNumberListTableTemplate = function({ donorPhoneNumberViewStore, t }) {
	const { tableStore, routes, phoneNumberModal, openPhoneNumberModal } = donorPhoneNumberViewStore;
...
function renderEmpty(routes) {
	return (
		<EmptyState
			image={EmptyIcon}
			title="PHONE_NUMBER.LIST.EMPTY_STATE.TITLE"
			actionLabel="PHONE_NUMBER.LIST.EMPTY_STATE.ACTION"
