...
const CharityPendingListTemplate = function({ charityPendingListViewStore }) {
	const { tableStore, routes, queryUtility, authorization } = charityPendingListViewStore;

	return (
		<ApplicationListLayout store={charityPendingListViewStore} authorization={authorization}>
...
CharityPendingListTemplate.propTypes = {
	charityPendingListViewStore: PropTypes.object.isRequired,
};
			...
			<div className="type--right">
				{isSome(onEdit) ? (
					<BaasicButton
						...
						icon="u-icon u-icon--edit u-icon--base u-mar--right--sml"
...
export default defaultTemplate(CharityPendingListTemplate);
