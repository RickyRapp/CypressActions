    ...
    render() {
        ...
        return <React.Fragment>
            <div className="pos--rel display--ib  spc--right--sml">
                    <input className={className} type="text" placeholder={placeholder} value={queryUtility.filter[propertyName] || ""} onChange={e => {
                    ...
                    {queryUtility.filter[propertyName] && queryUtility.filter[propertyName] !== '' &&
                        <button className="btn btn--input-icon  input__icon" onClick={() => queryUtility.filter[propertyName] = null}>
                ...
                <button className="btn btn--med btn--tertiary">
                    ...
                    <span className="align--v--bottom" onClick={() => queryUtility.fetch()}>
                        Search
                    </span>
                </button>
            </React.Fragment>;
