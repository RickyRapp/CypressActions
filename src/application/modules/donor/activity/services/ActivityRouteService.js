...
class ActivityRouteService extends BaseRouteService {
    ...
    findTransactions(filter) {
        return super.find(this.base + '/transactions/{?donorId,searchQuery,dateCreatedFrom,dateCreatedTo,paymentTransactionType,paymentTransactionPeriod,page,rpp,sort,embed,fields}', filter);
    }
