...
import { DonorAccountEmailAddressEditForm } from 'application/donor-account/components';

const DonorAccountEmailAddressListTableTemplate = function ({ donorAccountEmailAddressViewStore, t }) {
    const {
        tableStore,
        routes,
        authorization,
    ...
    } = donorAccountEmailAddressViewStore;
    ...
    return (
        <div>
            ...
            <BaasicModal modalParams={emailAddressModal}>
                <DonorAccountEmailAddressEditForm />
            </BaasicModal>
        </div>
    )
};
...
DonorAccountEmailAddressListTableTemplate.propTypes = {
    donorAccountEmailAddressViewStore: PropTypes.object.isRequired,
...
export default defaultTemplate(DonorAccountEmailAddressListTableTemplate);
