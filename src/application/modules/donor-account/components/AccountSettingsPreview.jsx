            ...
            <React.Fragment>
                ...
                <div className="row">
                    <div className="form__group col col-sml-6 col-lrg-2 u-mar--bottom--sml">
                        <label className="form__group__label">{t('DONOR_ACCOUNT.ACCOUNT_SETTINGS_FIELDS.LINE_OF_CREDIT_LABEL')}</label>
                        {item &&
                            <FormatterResolver
                    ...
                    <div className="form__group col col-sml-6 col-lrg-2 u-mar--bottom--sml">
                        <label className="form__group__label">{t('DONOR_ACCOUNT.ACCOUNT_SETTINGS_FIELDS.CERTIFICATE_DEDUCTION_LABEL')}</label>
                        {item &&
                            <FormatterResolver
                    ...
                    <div className="form__group col col-sml-6 col-lrg-2 u-mar--bottom--sml">
                        <label className="form__group__label">{t('DONOR_ACCOUNT.ACCOUNT_SETTINGS_FIELDS.CERTIFICATE_FEE_LABEL')}</label>
                        {item &&
                            <FormatterResolver
                    ...
                    <div className="form__group col col-sml-6 col-lrg-2 u-mar--bottom--sml">
                        <label className="form__group__label">{t('DONOR_ACCOUNT.ACCOUNT_SETTINGS_FIELDS.CONTRIBUTION_MINIMUM_ADDITIONAL_LABEL')}</label>
                        {item &&
                            <FormatterResolver
                    ...
                    <div className="form__group col col-sml-6 col-lrg-2 u-mar--bottom--sml">
                        <label className="form__group__label">{t('DONOR_ACCOUNT.ACCOUNT_SETTINGS_FIELDS.CONTRIBUTION_MINIMUM_INITIAL_LABEL')}</label>
                        {item &&
                            <FormatterResolver
                    ...
                    <div className="form__group col col-sml-6 col-lrg-2 u-mar--bottom--sml">
                        <label className="form__group__label">{t('DONOR_ACCOUNT.ACCOUNT_SETTINGS_FIELDS.GRANT_FEE_LABEL_LABEL')}</label>
                        {item &&
                            <FormatterResolver
                    ...
                    <div className="form__group col col-sml-6 col-lrg-2 u-mar--bottom--sml">
                        <label className="form__group__label">{t('DONOR_ACCOUNT.ACCOUNT_SETTINGS_FIELDS.GRANT_MINIMUM_AMOUNT_LABEL')}</label>
                        {item &&
                            <FormatterResolver
                    ...
                    <div className="form__group col col-sml-6 col-lrg-2 u-mar--bottom--sml">
                        <label className="form__group__label">{t('DONOR_ACCOUNT.ACCOUNT_SETTINGS_FIELDS.INITIAL_CONTRIBUTION_LABEL')}</label>
                        {item &&
                            <FormatterResolver
                    ...
                    {isPremiumAccount &&
                        <div className="form__group col col-sml-6 col-lrg-2 u-mar--bottom--sml">
                            <label className="form__group__label">{t('DONOR_ACCOUNT.ACCOUNT_SETTINGS_FIELDS.EXTRA_BOOKLET_PERCENTAGE_LABEL')}</label>
                            {item &&
                                <FormatterResolver
