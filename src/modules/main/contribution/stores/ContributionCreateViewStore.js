...
class ContributionCreateViewStore extends BaseViewStore {
    ...
    @action.bound async initializeForm() {
        ...
        const fields = ContributionCreateFormFields(this.achId, this.checkId, this.chaseQuickPayId, this.stockAndMutualFundsId, this.lowBalanceAmountId, this.oneTimeId, this.everyTwoWeeksId, this.everyTwoMonthsId, this.everySixMonthsId, this.weeklyId, this.monthlyId, minimumAmount, this.donorAccount);
