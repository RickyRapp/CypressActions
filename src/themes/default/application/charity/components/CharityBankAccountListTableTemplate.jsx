...
import { CharityBankAccountEditForm } from 'application/charity/components';

const CharityBankAccountListTableTemplate = function ({ charityBankAccountViewStore, t }) {
    const {
        tableStore,
        routes,
        authorization,
    ...
    return (
        <div>
            ...
            <BaasicModal modalParams={bankAccountModal}>
                <CharityBankAccountEditForm useDonorContactInformations={useDonorContactInformations} />
            </BaasicModal>
        </div>
    )
};
...
CharityBankAccountListTableTemplate.propTypes = {
...
export default defaultTemplate(CharityBankAccountListTableTemplate);
