...
import { BookletEditForm } from 'application/administration/booklet/forms';
...
class BookletEditViewStore extends BaseViewStore {
    ...
    form = new BookletEditForm({
        onSuccess: async form => {
            ...
            const data = await this.rootStore.application.administration.bookletStore.updateCertificate(item);
    ...
    async getResource() {
        ...
        this.booklet = await this.rootStore.application.administration.bookletStore.getBooklet(this.id, params);
    }
