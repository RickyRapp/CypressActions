...
class Router {
  ...
  constructor(rootStore, routes, notFoundState) {
    ...
    reaction(
      ...
      routerState => {
        ...
        var index = _.findIndex(routeHistory, {
          routeName: routerState.routeName
        });
  ...
  goTo(destination, params, queryParams) {
    // old compatibility
  ...
  updateQueryParams(params) {
    ...
    var toRoute =
      routeHistory.length === 0
        ...
        : currentRoute.name;
    return this.silentTransition(toRoute, {
      ...this.routerStore.routerState.queryParams,
      ...params
    });
  }
  ...
  silentTransition(route, params) {
    ...
    return this.navigate(
      route,
      this.routerStore.routerState.params,
      params
    ).then(() => {
...
function getNextRouterState(rootStore, routeName, params, queryParams) {
  ...
  if (
    (_.isNil(params) || _.isNil(params.appId)) &&
    _.startsWith(routeName, 'master.app.')
  ) {
    if (
      routerState.params &&
      !_.isNil(routerState.params.appId) &&
      routerState.params.appId !== ''
    ) {
