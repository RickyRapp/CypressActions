	...
	return (
		<div>
			<div className="card--primary card--med u-mar--bottom--med">
				<h3 h3 className=" u-mar--bottom--sml">
					...
					>
						{primaryAddress ? (
							...
							<div className="row">
								...
								<div className="col col-sml-6 col-lrg-4 u-mar--bottom--med">
									<p className="type--sml type--wgt--regular type--color--opaque u-mar--bottom--sml">Address Line 2:</p>
				...
				<div
					className={`u-mar--top--sml ${
						(isEditEnabled && primaryAddress === null) || (primaryAddress && primaryAddress.id === editId)
							? 'u-padd--x--med'
							: ''
					}`}
				>
					{isEditEnabled && ((secondaryAddress && secondaryAddress.id === editId) || undefined === editId) ? (
						...
						<React.Fragment>
							<p className="type--sml type--wgt--regular type--color--opaque u-mar--bottom--sml">Secondary Address</p>
							<span
