        ...
        this.selectDonorModal.open(
            {
                ...
                onClickDonorFromFilter: (donorId) => this.rootStore.routerStore.goTo('master.app.main.donor.grant.create', null, { id: donorId }),
                onChange: (donorId) => this.rootStore.routerStore.goTo('master.app.main.donor.grant.create', null, { id: donorId })
            });
    }
}
