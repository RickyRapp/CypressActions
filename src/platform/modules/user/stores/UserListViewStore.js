...
class UserListViewStore extends BaseListViewStore {
    ...
    constructor(rootStore) {
        const userService = rootStore.platform.baasic.membershipModule.user;
            ...
            routes: {
                detail: id =>
                    this.rootStore.routerStore.navigate(
                        "master.platform.main.user.preview",
                        { id }
                    ),
                edit: id =>
                    this.rootStore.routerStore.navigate(
                        "master.platform.main.user.edit",
                        { id: id }
                    ),
                create: () =>
                    this.rootStore.routerStore.navigate(
                        "master.platform.main.user.create"
                    )
            },
            actions: {
                find: async (params) => {
