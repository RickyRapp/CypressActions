...
import { DonorEmailAddressEditForm } from 'application/administration/donor/forms';
...
class DonorEmailAddressViewStore extends BaseListViewStore {
            ...
            actions: () => {
                return {
                    find: async (params) => {
                        ...
                        return rootStore.application.administration.donorStore.findEmailAddress(params);
                    }
                }
            }
        });
    ...
    async updateEmailAddressAsync(entity, message) {
        try {
            await this.rootStore.application.administration.donorStore.updateEmailAddress(entity);
    ...
    async createEmailAddressAsync(entity) {
        try {
            await this.rootStore.application.administration.donorStore.createEmailAddress({
