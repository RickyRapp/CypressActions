...
function NullableSwitchTemplate({ value, onChange, label, yesLabel, noLabel, t, yesValue = true, noValue = false }) {
    ...
    return (
        <div>
            ...
            <div className='input--treeway u-display--flex u-display--flex--align--center'>
                ...
                <label className="u-mar--right--sml u-mar--left--sml">|</label>
                <input type='radio' id={noneId} name={noneId} checked={_.isNil(value)} onChange={() => onChange(null)} />
                <label htmlFor={noneId} className="u-mar--right--sml u-mar--left--sml">|</label>

                <input type='radio' id={offId} name={offId} checked={value === noValue} onChange={() => onChange(noValue)} />
                <label className='input--treeway__label--last u-mar--left--sml' htmlFor={offId}><i className='icomoon icon-remove padd--top--xtny display--ib'>{t(noLabel)}</i></label>
