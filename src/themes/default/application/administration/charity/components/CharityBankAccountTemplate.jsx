		...
		<div>
			<EditFormContent form={form}>
				...
				<div className="bank__footer">
					<div className="bank__footer__buttons">
						<BaasicButton
							className="btn btn--med btn--ghost--warning u-mar--bottom--sml"
						...
						<span className="u-display--ib u-mar--left--sml u-mar--bottom--sml">
