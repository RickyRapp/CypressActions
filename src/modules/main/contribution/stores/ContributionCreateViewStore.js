...
import { ContributionCreateForm, ContributionEditForm } from 'modules/main/contribution/forms';
...
class ContributionCreateViewStore extends BaseEditViewStore {
    ...
    constructor(rootStore) {
        ...
        let userId = rootStore.authStore.user.id;
    ...
    @action.bound async load() {
        ...
        if (this.isEdit) {
            ...
            else if (!(this.item.contributionStatusId === this.pendingId || this.item.contributionStatusId === this.inProcessId)) {
                this.rootStore.routerStore.navigate('master.app.administration.contribution.list')
