...
class MembershipViewStore {
    routes = {
        register: () => this.moduleStore.rootStore.routerStore.navigate('master.app.membership.register'),
        login: () => this.moduleStore.rootStore.routerStore.navigate('master.app.membership.login'),
