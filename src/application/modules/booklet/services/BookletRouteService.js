...
class BookletRouteService extends BaseRouteService {
    ...
    find(filter) {
        return super.find(this.base + '/{?donorAccountId,bookletStatusIds,denominationTypeIds,codes,certificateBarcodes,dateCreatedStartDate,dateCreatedEndDate,page,rpp,sort,embed,fields}', filter);
    }
