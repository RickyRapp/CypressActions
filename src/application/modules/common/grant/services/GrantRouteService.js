...
class GrantRouteService extends BaseRouteService {
    constructor() {
        super('grant');
        this.filterFields = 'donorId,charityId,confirmationNumber,amountRangeMin,amountRangeMax,donationStatusIds,donationTypeIds,dateCreatedFrom,dateCreatedTo,search,name,taxId,grantId,page,rpp,sort,embed,fields'
    }
