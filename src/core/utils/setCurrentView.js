...
function setCurrentView(getView, name = 'currentView') {
    return function (Component) {
        @inject((i, p) => {
            const {parentView, props, ref, rootStore, ...componentProps} = p; // eslint-disable-line
        ...
        class WrapComponent extends React.Component {
            ...
            initializeView({ rootStore, parentView, storeName, componentProps }) {
                ...
                currentView.store_path = parent && parent !== rootStore
                    ? parent.store_path + '.' + customStoreName
                    : customStoreName;
