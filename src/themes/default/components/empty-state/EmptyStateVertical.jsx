...
const EmptyStateVerticalTemplate = function(props) {
  ...
  return (
    <div className="emptystate--vertical">
      ...
      {title && <h3 className="emptystate--vertical__title">{t(title)}</h3>}

      {description && (
        <p className="emptystate--vertical__description">{t(description)}</p>
      )}
      ...
      {callToAction && (
        <div className="emptystate--vertical__action">
          <label className="emptystate--vertical__action__label">
            {t(actionLabel)}
          </label>
