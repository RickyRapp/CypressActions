...
function DonorAccountAdministrationCreateTemplate({ donorAccountAdministrationCreateViewStore }) {
    const {
        form,
        loading,
        basicId,
    ...
    } = donorAccountAdministrationCreateViewStore;
...
export default defaultTemplate(DonorAccountAdministrationCreateTemplate);
