    ...
    return (
        <EditFormContent form={form} loading={loaderStore.loading}>
            ...
            <div className="row">
                ...
                <div className="form__group col col-sml-12 col-xxlrg-5">
                ...
                <div className="form__group col col-sml-12 col-xxlrg-2 u-align--self--end"></div>

                <div className="form__group col col-sml-12 col-xxlrg-5 u-align--self--end">
