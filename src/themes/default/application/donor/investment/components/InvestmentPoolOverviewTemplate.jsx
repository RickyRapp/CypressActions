				...
				<div className="card--primary card--lrg u-mar--bottom--med">
					<div className="row u-mar--bottom--sml">
						<div className="col col-sml-12 u-mar--bottom--sml">
							<h4 className="type--xlrg type--wgt--medium">Pool Title</h4>
						...
						<div className="col col-sml-12">
							<div className="row">
								<div className="col col-sml-12 col-xxlrg-6 u-mar--bottom--sml u-separator--right--primary--from--xlrg u-separator--bottom--primary--to--lrg u-padd--right--base ">
									<div className="row">
								...
								<div className="col col-sml-12 col-xxlrg-3 u-padd--right--base u-padd--left--base">
									...
									<div className="row">
										...
										<div className="col col-sml-12 col-xxlrg-6 u-mar--bottom--sml">
											<span className="type--sml type--wgt--regular type--color--opaque u-mar--right--sml">
												10 YTD:
											</span>
