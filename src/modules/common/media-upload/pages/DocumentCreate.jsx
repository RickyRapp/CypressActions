...
@setCurrentView((rootStore, props) => new MediaUploadCreateViewStore(rootStore, { onRefresh: props.onRefresh, uploadFunc: props.uploadFunc }), 'mediaUploadCreateViewStore')
@observer
