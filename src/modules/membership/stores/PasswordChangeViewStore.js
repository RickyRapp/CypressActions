...
class PasswordChangeViewStore extends BaseViewStore {
    passwordChangeForm = new PasswordChangeForm({
        onSuccess: async (form) => {
            ...
            const passwordRecoveryToken = this.rootStore.routerStore.routerState.queryParams.passwordRecoveryToken;
    ...
    @action.bound async goToLogin() {
        await this.rootStore.routerStore.navigate('master.app.membership.login', { appId: this.rootStore.routerStore.routerState.params.appId });
    }
}
