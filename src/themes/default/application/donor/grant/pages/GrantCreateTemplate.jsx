...
import { InsightsCardLoaderTemplate, GrantDetailsLoaderTemplate } from '../components';
												...
												<div className="form__group col col-sml-12 col-lrg-12 u-mar--bottom--sml">
													{(moreSettings || window.innerWidth > 750) && form.$('grantPurposeTypeId').value && (
														<GrantPurposeTypeTemplate
															form={form}
															grantPurposeType={grantPurposeTypes.find(
																c => c.id === form.$('grantPurposeTypeId').value
															)}
														/>
													)}
												</div>
