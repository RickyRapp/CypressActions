...
const DateRangePickerFieldTemplate = function(props) {
    ...
    let values = { start: !fromField.value ? null : new Date(fromField.value), end: !toField.value ? null : new Date(toField.value)}
    ...
    return (
        <DateRangePicker value={values} onChange={onChange} t={t} errors={errors} required={required}/>
    );
};
