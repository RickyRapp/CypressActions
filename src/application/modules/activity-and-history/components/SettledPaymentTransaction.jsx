...
@setCurrentView((rootStore, props) => new SettledPaymentTransactionViewStore(rootStore, { donorId: props.donorId, charityId: props.charityId }), 'settledPaymentTransactionViewStore')
@observer
