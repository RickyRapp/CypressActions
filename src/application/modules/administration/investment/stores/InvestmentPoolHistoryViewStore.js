...
import { InvestmentPoolHistoryFilter } from 'application/administration/investment/models';
            ...
            actions: () => {
                return {
                    find: async (params) => {
                        ...
                        return rootStore.application.administration.investmentStore.findHistory(params);
                    }
                }
            }
        });
