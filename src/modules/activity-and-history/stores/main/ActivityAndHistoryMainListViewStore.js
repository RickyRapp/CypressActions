...
import { ActivityAndHistoryMainListFilter } from 'modules/activity-and-history/models';
import { BaasicDropdownStore, BaseListViewStore, TableViewStore } from "core/stores";
import _ from 'lodash';

class ActivityAndHistoryMainListViewStore extends BaseListViewStore {
    ...
    constructor(rootStore) {
        ...
        let filter = new ActivityAndHistoryMainListFilter();
...
export default ActivityAndHistoryMainListViewStore;