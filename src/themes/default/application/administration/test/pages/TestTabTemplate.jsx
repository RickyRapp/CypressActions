...
import { TestEmailList, TestReportList, ScheduledSettingList, WelcomeExistingAccountsEmails, APITesting, AnnualReceipt } from 'application/administration/test/pages';
        ...
        <Page loading={loaderStore.loading} >
            <div className='u-mar--bottom--med'>
                <TabLayout store={testTabViewStore}>
                    ...
                    <div label={'TEST.TAB.ANNUAL_RECEIPTS'} className="u-mar--top--sml">
                        <AnnualReceipt />
                    </div>
