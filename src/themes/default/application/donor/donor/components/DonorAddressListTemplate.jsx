...
const DonorAddressListTemplate = function({ donorAddressViewStore, t }) {
	const { tableStore, routes, addressModal, openAddressModal } = donorAddressViewStore;
...
function renderEmpty(routes) {
	return (
		<EmptyState
			image={EmptyIcon}
			title="ADDRESS.LIST.EMPTY_STATE.TITLE"
			actionLabel="ADDRESS.LIST.EMPTY_STATE.ACTION"
