import { CharityWithdrawFundForm } from 'application/administration/charity/forms';
            ...
            actions: () => {
                return {
                    ...
                    update: async (resource) => {
                        await this.rootStore.application.administration.charityStore.withdrawFundCharity(resource);
                    }
                }
            },
