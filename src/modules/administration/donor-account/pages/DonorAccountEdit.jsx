...
import { DonorAccountProfileEdit } from 'modules/administration/donor-account/pages'
...
import { DonorAccountSettingEdit } from 'modules/administration/donor-account/pages'
                        ...
                        <div className="form__group f-col f-col-lrg-6">
                            <div className="f-row">
                                <div className="form__group f-col f-col-lrg-12">
                                    <DonorAccountProfileEdit fetchedDonorAccount={this.donorAccount} />
                                </div>
                                <div className="form__group f-col f-col-lrg-12">
                                    <DonorAccountSettingEdit fetchedDonorAccount={this.donorAccount} columns={4} />
                                </div>
                                <div className="form__group f-col f-col-lrg-12">
                                    <DonorNoteList />
                                </div>
