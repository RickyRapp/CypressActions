...
function ActivityAndHistoryAdministrationListTemplate({ activityAndHistoryAdministrationListViewStore }) {
    const {
        queryUtility,
        loaderStore,
        tableStore,
        ...
        loaded,
    } = activityAndHistoryAdministrationListViewStore;
...
export default defaultTemplate(ActivityAndHistoryAdministrationListTemplate);
