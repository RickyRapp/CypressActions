...
import { InvestmentPoolEditForm } from 'application/administration/investment/forms';
            ...
            actions: () => {
                return {
                    get: async () => {
                        ...
                        const data = await rootStore.application.administration.investmentStore.findOverview(params);
                        const temp = [];
                    ...
                    update: async (resource) => {
                        await rootStore.application.administration.investmentStore.updatePoolChange(resource.investmentPoolHistory);
                    }
                }
            },
