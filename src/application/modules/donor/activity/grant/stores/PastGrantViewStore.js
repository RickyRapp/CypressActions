            ...
            actions: () => {
                return {
                    find: async (params) => {
                        ...
                        const tableData = await rootStore.application.donor.grantStore.findPastGrants({ donorId: this.donorId, ...params });
                        this.summaryData = await rootStore.application.donor.grantStore.findSummaryPastGrants({ donorId: this.donorId, ...params });
                        return tableData;
                    }
                }
            }
