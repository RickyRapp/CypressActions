...
class GrantRouteService extends BaseRouteService {
    constructor() {
        super('grant');
        this.filterFields = 'donorId,charityId,confirmationNumber,donationStatusIds,donationTypeIds,search,name,taxId,grantId,page,rpp,sort,embed,fields'
    }
    ...
    findPastGrant(params) {
        return super.find(this.base + '/donor/{?donorId,charityId,donationStatusIds,donationTypeIds,amountRangeMin,amountRangeMax,confirmationNumber,grantMemo,bookletCertificateCode,dateCreatedFrom,dateCreatedTo,page,rpp,sort,embed,fields}', params);
    }
