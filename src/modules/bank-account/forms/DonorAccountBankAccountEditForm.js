    ...
    setup() {
        return {
            ...
            rules: {
                ...
                'accountHolder.address.addressLine1': 'required_if:thirdParty, true|string',
                'accountHolder.address.addressLine2': 'string',
                'accountHolder.address.city': 'required_if:thirdParty, true|string',
                'accountHolder.address.state': 'required_if:thirdParty, true|string',
