...
import { BookletOrderCreateForm } from 'application/administration/booklet-order/forms';
            ...
            actions: () => {
                return {
                    create: async (resource) => {
                        await this.rootStore.application.administration.bookletOrderStore.createBookletOrder({
